...
--------------------------------------------------
    ...
    if showBF then
        ...
        setProperty('bfPhantom.color', '000000')
...
-----------------------------boyfriend sprite---------------------
    ...
    if showDAD then
        ...
        setProperty('dadPhantom.color', '000000')
...
--------------------------dad sprite--------------------------
    ...
    if showGF and getProperty('gf.visible') == true then
        ...
        setProperty('gfPhantom.color', '000000')
...
-----------------------------boyfriend playanim---------------
    ...
    dadoffsetX = getProperty('dad.offset.x')
    dadangle = getProperty('dad.angle')
...
-----------------------------dad playanim---------------
    ...
    gfoffsetX = getProperty('gf.offset.x')
    gfoffsetY = getProperty('gf.offset.y')
    gfangle = getProperty('gf.angle')
    
    
    

    
    setProperty('bfPhantom.origin.y',gfangle)
    setProperty('gfPhantom.offset.x',gfoffsetX)
    setProperty('gfPhantom.offset.y',gfoffsetY)
    setProperty('gfPhantom.offset.x',gfoffsetX)
